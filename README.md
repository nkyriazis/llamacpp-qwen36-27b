...
- Desktop VRAM use (~2.2 GB here) is the margin to watch: the full 262K fits with it, at about 30.2 of 32.6 GB in use. Other GPU apps (games, Steam, CUDA jobs) can push the server into CUDA OOM.
